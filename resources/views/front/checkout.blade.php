                            ...
                            <div class="col-md-8">
                                <div class="checkout-left">
                                    <div class="panel-group" id="accordion">
                                        ...
                                        <input type="button" value="Login" class="aa-browse-btn" data-toggle="modal"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="aa-checkout-single-bill">
                                                                <input type="email" placeholder="Email Address*"
                                                                    value="{{$customers['email']}}" name="email"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="aa-checkout-single-bill">
                                                                <input type="tel" placeholder="Phone*"
                                                                    value="{{$customers['mobile']}}" name="mobile"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="aa-checkout-single-bill">
                                                                <input type="text" placeholder="State*"
                                                                    value="{{$customers['state']}}" name="state"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="checkout-right">
                                    ...
                                    <div class="aa-payment-method">
                                        ...
                                        <label for="esewa">
                                            <input type="radio" id="payment-button" name="payment_type" value="Gateway"> Via
                                            Khalti </label>
