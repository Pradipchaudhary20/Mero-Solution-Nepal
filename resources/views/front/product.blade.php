                                    ...
                                    <div id="demo-1" class="simpleLens-gallery-container">
                                        ...
                                        <div class="simpleLens-thumbnails-container">
                                            ...
                                            <a data-big-image="{{asset('storage/media/'.$list->images)}}"
                                                ...
                                                class="simpleLens-thumbnail-wrapper" href="#"><img
                                                    src="{{asset('storage/media/'.$list->images)}}" width="70px">
                                            </a>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="aa-product-view-content">
                                    ...
                                    <div class="aa-price-block">
                                        ...
                                        <p class="aa-product-avilability">Availibility: <span>In stock</span></p>
                                    ...
                                    <div class="aa-color-tag">
                                        ...
                                        <a href="javascript:void(0)" class="aa-color-{{strtolower($attr->color)}}"
                                    ...
                                    <div class="aa-prod-view-bottom">
                                        <a class="aa-add-to-cart-btn" href="javascript:void(0)"
                                            onclick="add_to_cart('{{$product[0]->id}}','{{$product_attr[$product[0]->id][0]->color_id}}')">Add
                                            To Cart</a>
                                    </div>
                                ...
                                <figure>
                                    ...
                                    <figcaption>
                                        ...
                                        <span class="aa-product-price">Rs
                                            {{$related_product_attr[$productArr->id][0]->price}}</span><span
                                            class="aa-product-price"><del>Rs
                                                {{$related_product_attr[$productArr->id][0]->mrp}}</del></span>
                                    </figcaption>
                                </figure>
                            </li>
                            @endforeach
